...
function mMT:mColorDatatext()
	local nhc, hc, myth, mythp, other, titel, tip = E.db[mPlugin].mDataText.colornhc.hex, E.db[mPlugin].mDataText.colorhc.hex, E.db[mPlugin].mDataText.colormyth.hex, E.db[mPlugin].mDataText.colormythplus.hex, E.db[mPlugin].mDataText.colorother.hex, E.db[mPlugin].mDataText.colortitel.hex, E.db[mPlugin].mDataText.colortip.hex
