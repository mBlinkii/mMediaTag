...
local function OnEnter(self)
	if E.db[mPlugin].mDock.tip.enable then
		...
		DT.tooltip:AddLine(format("%s %s%s|r", ns.MiddleButtonIcon, tip, L["Middle Click: Change Talent Specialization"]))
...
DT:RegisterDatatext(mTextName, "mDock", {'CHARACTER_POINTS_CHANGED', 'PLAYER_TALENT_UPDATE', 'ACTIVE_TALENT_GROUP_CHANGED', 'PLAYER_LOOT_SPEC_UPDATED', 'GROUP_ROSTER_UPDATE'}, OnEvent, nil, OnClick, OnEnter, OnLeave, mText, nil, nil)