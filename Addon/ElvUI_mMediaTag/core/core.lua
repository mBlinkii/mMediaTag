	...
	if mui_tbl.loaded then
		...
		if mui_tbl.custom then
			mui_tbl.colors = {
				...
				["DEATHKNIGHT"] = { a = { r = c.deathknightcolorR1, g = c.deathknightcolorG1, b = c.deathknightcolorB1, a = 1 }, b = { r = c.deathknightcolorR2, g = c.deathknightcolorG2, b = c.deathknightcolorB2, a = 1 } },
				...
				["DEMONHUNTER"] = { a = { r = c.demonhuntercolorR1, g = c.demonhuntercolorG1, b = c.demonhuntercolorB1, a = 1 }, b = { r = c.demonhuntercolorR2, g = c.demonhuntercolorG2, b = c.demonhuntercolorB2, a = 1 } },
