...
local mMTSettingsLoader = CreateFrame("FRAME")
mMTSettingsLoader:RegisterEvent("ADDON_LOADED")

function mMTSettingsLoader:OnEvent(event, arg1)
...
mMTSettingsLoader:SetScript("OnEvent", mMTSettingsLoader.OnEvent)
