	...
	args = {
		...
		unitframes = {
			...
			args = {
				...
				important_casts = {
					order = 3,
					type = "group",
					name = mMT:AddSettingsIcon("Important Casts", "time"),
					childGroups = "tab",
					args = {},
				},
				role_icons = {
		...
		nameplates = {
			...
			args = {
				...
				auto_friendly_nameplates = {
					order = 5,
					type = "group",
					name = mMT:AddSettingsIcon(L["Auto Friendly Nameplates"], "nameplates"),
					childGroups = "tab",
					args = {},
				},
		...
		cooldownmanager = {
			...
			icon = "Interface\\Addons\\ElvUI_mMediaTag\\media\\options\\time",
			childGroups = "tab",
			args = {
				general = {
					order = 1,
				...
				essential = {
					order = 2,
					type = "group",
					name = mMT:AddSettingsIcon(L["Essential Cooldowns"], "time"),
					childGroups = "tab",
					args = {},
				},
				utility = {
					order = 3,
					type = "group",
					name = mMT:AddSettingsIcon(L["Utility Cooldowns"], "time"),
					childGroups = "tab",
					args = {},
				},
				buff_icon = {
					order = 4,
					type = "group",
					name = mMT:AddSettingsIcon(L["Buff Icons"], "time"),
					childGroups = "tab",
					args = {},
				},
				buff_bar = {
					order = 5,
					type = "group",
					name = mMT:AddSettingsIcon(L["Buff Bars"], "time"),
					childGroups = "tab",
					args = {},
				},
				custom = {
					order = 6,
					type = "group",
					name = mMT:AddSettingsIcon(L["Custom Tracker"], "time"),
					childGroups = "tab",
					args = {},
				},
			},
		...
		dock = {
			...
			args = {
				...
				housing = {
					order = 20,
					type = "group",
					name = mMT:AddSettingsIcon(L["Housing"], "housing"),
					childGroups = "tab",
					args = {},
				},
				notification = {
		...
		skins = {
			...
			args = {
				...
				aussyloot = {
					order = 2,
					type = "group",
					name = mMT:AddSettingsIcon("AussyLoot", "bag"),
					childGroups = "tab",
					args = {},
				},
				bigwigs = {
