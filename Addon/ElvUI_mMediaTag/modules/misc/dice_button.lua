	...
	if E.db.mMT.dice_button.enable then
		if not module.dice_button then
			...
			module.dice_button:SetScript("OnEnter", function()
				...
				_G.GameTooltip:AddLine(L["Roll Button"], mMT:GetRGB("title"))
				_G.GameTooltip:AddLine(" ")
				_G.GameTooltip:AddDoubleLine(MEDIA.leftClick .. " " .. L["Left Click to roll"], module.db.dice_range_a, mMT:GetRGB("text", "mark"))
				_G.GameTooltip:AddDoubleLine(MEDIA.rightClick .. " " .. L["Right Click to roll"], module.db.dice_range_b, mMT:GetRGB("text", "mark"))
				_G.GameTooltip:Show()
			end)
