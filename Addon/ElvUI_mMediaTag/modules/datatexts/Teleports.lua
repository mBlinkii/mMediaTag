...
local function ValueColorUpdate(self, hex)
	print(E.db.mMT.datatexts.text.override_text, MEDIA.color.override_text.hex)
...
DT:RegisterDatatext("mTeleports", mMT.DatatextString, nil, OnEvent, nil, OnClick, OnEnter, OnLeave, L["Teleports"], nil, ValueColorUpdate)
