...
DT:RegisterDatatext("mMT_ResonanceCrystals", _G.CURRENCY, { "CHAT_MSG_CURRENCY", "CURRENCY_DISPLAY_UPDATE" }, OnEvent, nil, nil, OnEnter, OnLeave, "mMT - Resonance Crystals", nil)
