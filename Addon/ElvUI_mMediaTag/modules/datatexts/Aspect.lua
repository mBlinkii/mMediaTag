...
local function OnEvent(self, event, ...)
	...
	if Currency.loaded then
		...
		if not hide then
			...
			elseif E.db.mMT.datatextcurrency.style == "auto" then
				color = mMT.ClassColor.hex
...
DT:RegisterDatatext("mAspect", _G.CURRENCY, { "BAG_UPDATE", "CHAT_MSG_CURRENCY", "CURRENCY_DISPLAY_UPDATE" }, OnEvent, nil, nil, OnEnter, OnLeave, "mMediaTag Aspect's Awakened Crest", nil)
