...
local customIcons = {
	colored = "Interface\\AddOns\\ElvUI_mMediaTag\\media\\icons\\datatexts\\fishing_a.tga",
	white = "Interface\\AddOns\\ElvUI_mMediaTag\\media\\icons\\datatexts\\fishing_b.tga",
}
...
local function OnEnter(self)
	profession = select(4, GetProfessions())
	if profession then
...
DT:RegisterDatatext("mMT - Fishing", mMT.Name, { "TRADE_SKILL_DETAILS_UPDATE", "SKILL_LINES_CHANGED" }, OnEvent, nil, OnClick, OnEnter, OnLeave, L["Fishing"], nil, ValueColorUpdate)
