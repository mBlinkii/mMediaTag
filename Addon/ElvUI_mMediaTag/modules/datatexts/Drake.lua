...
DT:RegisterDatatext("mDrake", _G.CURRENCY, { "BAG_UPDATE", "CHAT_MSG_CURRENCY", "CURRENCY_DISPLAY_UPDATE" }, OnEvent, nil, nil, OnEnter, OnLeave, "mMediaTag Drake's Awakened Crest", nil)
