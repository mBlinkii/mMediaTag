...
L["Same as mMT-deathcount, but only shows the count while the player is dead."] = "與 mMT-deathcount 相同，但只有在玩家死亡時才顯示計數。"
...
L["Returns the classification of the unit. You can specify up to three arguments to display only certain classifications.\nFor example: [mClass{rare:elite}] will only show something if the unit is either rare or elite."] = "回傳單位的分類。你可以指定最多三個參數，只顯示某些分類。\n例如：[mClass{rare:elite}] 只有當單位是稀有或精英時才會顯示。"
L["Returns the color of the unit. Players are colored by class, NPCs by classification. You can specify up to three arguments to display only certain classifications.\nFor example: [mColor{rare:elite}] will only show something if the unit is either rare or elite."] = "回傳單位的顏色。玩家依職業著色，NPC 依分類著色。你可以指定最多三個參數，只顯示某些分類。\n例如：[mColor{rare:elite}] 只有當單位是稀有或精英時才會顯示。"
L["Returns the current health and percent of the unit or it will return the status (AFK, DND, Offline, Dead, Ghost)."] = "回傳單位目前生命值與百分比，或回傳其狀態（AFK、DND、離線、死亡、靈魂）。"
L["Returns the current health of the unit (changes between max health and percent in combat) including absorbs or it will return the status (AFK, DND, Offline, Dead, Ghost)."] = "回傳單位目前生命值（戰鬥中會在最大生命值與百分比之間切換），包含吸收值，或回傳其狀態（AFK、DND、離線、死亡、靈魂）。"
L["Returns the current health of the unit (changes between max health and percent in combat) or it will return the status (AFK, DND, Offline, Dead, Ghost)."] = "回傳單位目前生命值（戰鬥中會在最大生命值與百分比之間切換），或回傳其狀態（AFK、DND、離線、死亡、靈魂）。"
L["Returns the current health of the unit (changes between max health and percent in combat). Does not return status."] = "回傳單位目前生命值（戰鬥中會在最大生命值與百分比之間切換）。不會回傳狀態。"
L["Returns the name of the unit. If in an instance, it will return the last word of the name."] = "回傳單位名稱。如果在副本中，則回傳名稱的最後一個詞。"
L["Returns the number of players currently targeting the unit, but only while in combat."] = "回傳目前以該單位為目標的玩家數量，但只在戰鬥中顯示。"
L["Returns the raid target marker icon of the unit."] = "回傳單位的團隊目標標記圖示。"
L["Returns the status icon of the unit (AFK, DND, Offline, Dead, Ghost) or the name of the unit."] = "回傳單位的狀態圖示（AFK、DND、離線、死亡、靈魂）或單位名稱。"
L["Returns the status of the unit (AFK, DND, Offline, Dead, Ghost) or the name of the unit."] = "回傳單位的狀態（AFK、DND、離線、死亡、靈魂）或單位名稱。"
L["Same as mColor, but only for the units target."] = "與 mColor 相同，但只針對該單位的目標。"
L["Same as mDeathCount, but only shows the count while the player is dead."] = "與 mDeathCount 相同，但只有在玩家死亡時才顯示計數。"
...
L["Returns the number of times the player has died since you entered the instance. Resets when you leave the instance."] = "回傳玩家自進入副本以來死亡的次數。離開副本時會重置。"
...
L["Prints a message to chat whenever a quest is auto-accepted or turned in."] = "每當任務自動接受或交付時，在聊天中輸出訊息。"
...
-- options/misc/tags.lua
L["DC/ Offline"] = "斷線 / 離線"
L["Health trashhold 1"] = "生命值閾值 1"
L["Health trashhold 2"] = "生命值閾值 2"
L["PvP"] = "PvP"
L["Raidtarget Markers"] = "團隊目標標記"
L["Set the first health trashhold."] = "設定第一個生命值閾值。"
L["Set the second health trashhold."] = "設定第二個生命值閾值。"
L["Targeting Players"] = "鎖定中的玩家"
...
L["These are just examples of how to create your own dock using ElvUIâ€™s custom data text bars..."] = "這些只是如何使用 ElvUI 自訂資料文字列來建立你自己的 Dock 的範例……"
L["Tip/ Menu"] = "提示 / 選單"
L["Tracker"] = "追蹤器"
