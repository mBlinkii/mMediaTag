...
L["Error importing profile. String is invalid or corrupted!"] = "Error al importar el perfil. ¡La cadena es inválida o está dañada!"

-- modules/datatexts/info_score.lua
L["Mythic+ Best Run: +"] = "Mejor recorrido de Mítico+: +"
L["Dungeon overview:"] = "Resumen de la mazmorra:"
L["Keystones in your Group"] = "Piedras angulares en tu grupo"
L["Level: "] = "Nivel: "
L["No Keystone"] = "Sin piedra angular"
L["Possible next upgrades:"] = "Posibles siguientes mejoras:"
...
L["Framerate:"] = "Cuadros por segundo:"
...
L["Spells"] = "Hechizos"
L["You can select your favourites in the settings."] = "Puedes seleccionar tus favoritos en la configuración."
...
L["Opening the spellbook via addons can lead to taints.\nThis occurs when protected Blizzard code is unintentionally modified or affected,\nwhich may result in malfunctions or UI restrictions."] = "Abrir el libro de hechizos mediante addons puede provocar contaminación.\nEsto ocurre cuando el código protegido de Blizzard se modifica o se ve afectado sin intención,\nlo que puede causar fallas o restricciones en la interfaz."

-- modules/dock/store.lua
L["WoW Token:"] = "Ficha de WoW:"

-- modules/misc/auto_quest.lua
L["[AutoQuest] Auto-accept paused (SHIFT held)."] = "[AutoQuest] Autoaceptar en pausa (SHIFT presionado)."
L["[AutoQuest] Auto-turn-in paused (SHIFT held)."] = "[AutoQuest] Autoentrega en pausa (SHIFT presionado)."
...
L["Could not add the texture."] = "No se pudo agregar la textura."
...
L["Name"] = "Nombre"
L["Returns icons of players currently targeting the unit, but only while in combat."] = "Devuelve los íconos de los jugadores que están apuntando actualmente a la unidad, pero solo en combate."
L["Returns the classification icon of the unit. You can specify up to three arguments to display only certain classifications.\nFor example: [mClass:icon{rare:elite}] will only show something if the unit is either rare or elite."] = "Devuelve el ícono de clasificación de la unidad. Puedes especificar hasta tres argumentos para mostrar solo ciertas clasificaciones.\nPor ejemplo: [mClass:icon{rare:elite}] solo mostrará algo si la unidad es rara o élite."
...
L["Returns the raid target marker icon of the unit."] = "Devuelve el ícono del marcador de objetivo de banda de la unidad."
L["Returns the status icon of the unit (AFK, DND, Offline, Dead, Ghost) or the name of the unit."] = "Devuelve el ícono de estado de la unidad (AFK, DND, desconectado, muerto, fantasma) o el nombre de la unidad."
...
L["Colored Text"] = "Texto con color"

-- options/misc/details.lua
L["Adds a button to show or hide details on click. The button is only visible on mouse over."] = "Agrega un botón para mostrar u ocultar Details al hacer clic. El botón solo es visible al pasar el mouse."
L["Details embeded"] = "Details incrustado"
L["Details Windows"] = "Ventanas de Details"
L["Embedded Settings"] = "Configuración incrustada"
...
L["Color Hover"] = "Color al pasar el mouse"
L["Color Normal"] = "Color normal"
L["Custom color"] = "Color personalizado"
L["Hover Color Style"] = "Estilo de color al pasar el mouse"
...
L["Phase Icon"] = "Ícono de fase"
L["Portraits"] = "Retratos"
L["Professions"] = "Profesiones"
L["Ready Check Icons"] = "Íconos de verificación de listo"
...
L["Cast Icon"] = "Ícono de lanzamiento"
L["Class colored"] = "Coloreado por clase"
L["Custom Textures"] = "Texturas personalizadas"
L["Death"] = "Muerte"
L["Enable"] = "Habilitar"
L["Enable Class colored Background"] = "Habilitar fondo coloreado por clase"
L["Focus"] = "Foco"
...
L["Delete all Settings"] = "Eliminar toda la configuración"
L["Disable"] = "Deshabilitar"
L["Export"] = "Exportar"
L["Import"] = "Importar"
L["Import/ Export of this Settings"] = "Importar/Exportar esta configuración"
L["Info: The Skin can be affected by other addons if they add a skin for all windows. To fix the problem, the skin must be deactivated in the other addon. This is not a bug of mMT."] = "Información: la apariencia puede verse afectada por otros addons si agregan una apariencia para todas las ventanas. Para solucionar el problema, la apariencia debe desactivarse en el otro addon. Esto no es un error de mMT."
...
L["Returns a PvP icon if the unit is flagged for PvP and belongs to either the Horde or Alliance faction."] = "Devuelve un ícono JcJ si la unidad está marcada para JcJ y pertenece a la Horda o a la Alianza."
L["Returns a quest icon if the unit is a quest mob."] = "Devuelve un ícono de misión si la unidad es un enemigo de misión."
L["Returns the class icon of the unit. You can specify a size between 16 and 128 (default is 64). Example: mClassIcon:style{32}"] = "Devuelve el ícono de clase de la unidad. Puedes especificar un tamaño entre 16 y 128 (predeterminado 64). Ejemplo: mClassIcon:style{32}"
L["Returns the current power percent of the unit, but only while in combat."] = "Devuelve el porcentaje actual de poder de la unidad, pero solo durante el combate."
L["Returns the faction icon of the unit (Horde or Alliance), but only if it's the opposite faction of the player."] = "Devuelve el ícono de facción de la unidad (Horda o Alianza), pero solo si es la facción opuesta a la del jugador."
L["Returns the faction icon of the unit (Horde or Alliance)."] = "Devuelve el ícono de facción de la unidad (Horda o Alianza)."
...
L["Returns the number of times the player has died since you entered the instance. Resets when you leave the instance."] = "Devuelve el número de veces que el jugador ha muerto desde que entraste a la instancia. Se reinicia al salir de la instancia."
L["Returns the role icon of the unit (Tank, Healer, DPS)."] = "Devuelve el ícono de rol de la unidad (Tanque, Sanador, DPS)."
L["Returns the role of the unit (Tank, Healer, DPS)."] = "Devuelve el rol de la unidad (Tanque, Sanador, DPS)."
L["Returns the status icon of the unit (AFK, DND, Offline, Dead, Ghost)."] = "Devuelve el ícono de estado de la unidad (AFK, DND, desconectado, muerto, fantasma)."
...
L["right click to open Great Vault"] = "Clic derecho para abrir la Gran Bóveda"
L["right click to use:"] = "Clic derecho para usar:"
L["Role Icons"] = "Íconos de rol"
...
L["for debug mode."] = "para el modo de depuración."

-- core/cmd.lua
L["Added dev GUID:"] = "GUID de desarrollador agregado:"
L["Available commands:"] = "Comandos disponibles:"
L["DEV mode active"] = "Modo DEV activo"
L["GUID:"] = "GUID:"
L["Lua errors off."] = "Errores de Lua desactivados."
...
L["Toggle debug mode with safe addons"] = "Alternar modo de depuración con addons seguros"
...
L["Enable to change the background color of the castbar."] = "Activa esto para cambiar el color de fondo de la barra de lanzamiento."
L["Marker"] = "Marcador"
...
L["Story"] = "Historia"
L["TW"] = "TW"
L["Timewalking"] = "Caminata temporal"
...
L["These colors are used for the tooltips of the datatexts."] = "Estos colores se usan para los tooltips de los textos de datos."
L["colors"] = "colores"

-- options/datatext/info_combat_time.lua
L["Hide delay"] = "Ocultar retardo"
...
L["Threshold value for the repair color, if this is active then you should repair your gear."] = "Valor umbral para el color de reparación; si esto está activo, deberías reparar tu equipo."
L["Threshold value for the repair color, if this is active, you should repair your equipment soon."] = "Valor umbral para el color de reparación; si esto está activo, deberías reparar tu equipo pronto."
