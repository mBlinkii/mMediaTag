...
## [ver. 3.80] - 15.01.2026
### UPDATE
- UPDATE - [System]: TOC files for TBC & Wrath.
...
## [ver. 3.32] - 28.03.2024
### FIX
- FIX - take care of JiberishIcons changes
- FIX - Offset settings for Portraits Moon texture
### Update
- UPDATE - Cleand up Portraits Settings
- UPDATE - Change Rare/Elite border toggle behavior for Portraits
### NEW
- NEW - Add class colored bg for Portraits class icons
- NEW - Add diffrent Styles for Portraits Class icons background
- NEW - New Portraits Texture simple Square
...
### FIX
- FIX - German Locals
- FIX - Prevent nil error with TAG icons and wrong settings
- FIX - Mirror bug for Portraits
- FIX - Shadow bug with class icons for Portraits
- FIX - Portraits of other units with class icons enabled
- FIX - Swapped settings for docks XIV BG and XIV MAUI
### Update
- UPDATE - Update TAG icon defaults
- UPDATE - add Reload UI popup for Portraits class icons settings tp prevent errors

## [ver. 3.28] - 04.02.2024
### FIX
- FIX - Removed unused Settings from TAG settings menu
- FIX - Portrait Rare/Elite Texture Border and Shadow was swapped
### Update
- UPDATE - optimized some TAGs
- UPDATE - MediaPack TOC files
### NEW
- NEW - TAG mHealth with no no decimal for percents, all available under ElvUI available TAGs
- NEW - TAG mRoleIcon:blizz and mRoleIcon:target:blizz with default Blizzard Icons
- NEW - Many new Border Textures
- NEW - Portrait Texture
- NEW - German localization from Dlarge, thx for your support.
...
## [ver. 3.24] - 10.11.2023
### FIX
- FIX - Bug in Classic Version
- FIX - Objective tracker Bar color

## [ver. 3.23.1] - 09.11.2023
### FIX
- FIX - Game Version in TOC Files

## [ver. 3.23] - 08.11.2023
### FIX
- FIX - Multiple Mover Menu entry's
- FIX - Bug in Dock Volume
- FIX - Prevent empty Portraits in preview
### Update
- UPDATE - Example Docks, Icons and a Color Version of XIV
- UPDATE - First and Second Profession Datatext is available in Classic
- UPDATE - Removed mPower:hideZero because default will hide if power is 0
- UPDATE - Portraits events
- UPDATE - Change custom class colors module, it uses now CUSTOM_CLASS_COLORS so and its a extra Addon, so every supported addon can use the colors
### NEW
- NEW - Tags mColor:rare, mClass:icon:noelite, mPower:percent:combat, mPower:percent:heal:combat
- NEW - Mail Icons
- NEW - More new Dock Icons
- NEW - Add LibAddonCompat to WoW Classic for Profession Datatexts
- NEW - Function Custom Datatext Background Colors
- NEW - New Border Texture
- NEW - Add frame level settings for each portrait frame
...
## [ver. 2.55] - 16.04.2021
### Added
- Colorful Icons for Profession, Systemmenu and Dungeon Datatexts
- Textures changed for mMediaTag 15, 15a, 16, 17, 18, , 19, 23, 24
### Update
- Bugfix Questracke Texthight
- Bugfix for Dock isclicked function
- Bugfix for Dock Notification Icon on LFDTool

## [ver. 2.54] - 09.04.2021
### Added
- New Dock Icon Calendar
- Now you can Creat 3 Example Dockbars
- Icons for Profession, Systemmenu and Dungeon Datatexts
### Update
- Dock Textcolore code cahnges

## [ver. 2.53] - 04.04.2021
### Added
- New Dock Icon for Professions
- New Dock Icon Textures
- New Dock Icons auto Fontsize
- New Functions for Dock Talent Icon
### Update
- Dropdown Menu
- System Menu
- Profession Menu
- Dock Notification Bugfix
- Dock Icon Textures are sortet in groups now

## [ver. 2.52] - 24.03.2021
### Update
- Dropdown Menu Position
- Update Addon Profile Setup

## [ver. 2.511] - 20.03.2021
### Update
- Combat Lockdown for DockIcons

## [ver. 2.51] - 20.03.2021
### Added
- New Valor Currency Datatext
- 4 new Dock Icons, FPS/ MS, Frinds, Durability, ItemLevel
- 20 new Dock Icon Textures 139 - 151
### Update
- Code Changes for Dock Icons
- Dock Icons extra Text Position for FPS/MS/ILVL
- Dock Icon - Guild, Tooltip and Menu
- Dock Icon - Character, can show Durability or ItemLevel
- Dock Icon - Main Menu, can show FPS or MS
- Activate from Opjectivtracker Skin aktivates also ElvUI Objective Skin
